...
@Config
@Autonomous(name = "Specimen Test", group = "Autonomous")
public class BlueSpecimen extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action collect2 = drive.actionBuilder(new Pose2d(24, 20, Math.toRadians(-35))).
                strafeToLinearHeading(new Vector2d(31, 22), Math.toRadians(36)).
                build();
        ...
        Action park = drive.actionBuilder(new Pose2d(-6, 30.3, Math.toRadians(-60))).
                splineTo(new Vector2d(45, 17), Math.toRadians(-20)).
                build();
